					...
					<div className="p-12 bg-white mx-auto rounded-3xl w-96 ">
						...
						<div className="space-y-3">
							...
							<div>
								<div className="flex items-center justify-between">
									<input
										className="w-1/2 text-sm  px-4 py-3  border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400 disabled:bg-gray-200 disabled:cursor-not-allowed"
										type="text"
										value={user.FName}
										name="FName"
										onChange={handleUserChange}
									...
									/>
									<input
										className="w-1/2 ml-2 text-sm  px-4 py-3  border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400 disabled:bg-gray-200 disabled:cursor-not-allowed"
										type="text"
										value={user.LName}
										name="LName"
										onChange={handleUserChange}
